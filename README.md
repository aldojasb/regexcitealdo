...
You can install the released version of regexcitealdo from
[CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("regexcitealdo")
```

And the development version from
[GitHub](https://github.com/aldojasb/regexcitealdo) with:

``` r
# install.packages("devtools")
devtools::install_github("aldojasb/regexcitealdo")
```
